...
<header class="w-full">
    ...
    <section class="mx-auto flex items-center justify-between border-t border-b border-black py-3 px-5 font-thin">
		<div>
      ...
      <div class="flex items-center"><Avatar src="{data.meta.avatar}" width="w-10" /><p class="px-2">Author: {data.meta.user}</p></div>
    </section>
