	...
	<div>
		...
		<div class="mx-auto max-w-7xl text-token grid grid-cols-1 md:grid-cols-4 lg:grid-cols-5 gap-4 p-4">
			...
			<div class="col-span-3 card card-hover overflow-hidden">
				<header>
				<img src="/images/banner2.png" class="bg-black/50 w-full " alt="Post" />
				</header>
						...
						<svelte:fragment slot="panel">
							...
							<article>
								...
								<section>
									...
									<div class="p-4">
									<span class="flex justify-between"><h3 class="h3" data-toc-ignore><a href={post.slug} class="title">{post.title}</a></h3><div class="justify-around"><Avatar src="{post.avatar}" width="w-10" /></div></span>							
