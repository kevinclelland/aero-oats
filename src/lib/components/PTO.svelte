  ...
  <div class="col-span-3 mx-auto max-w-lg">
    <p class="text-center text-ao-pink dark:text-ao-orange text-3xl font-semibold p-4">Unofficial PTO Points Calculator</p>
    ...
    <p class="italic text-center text-sm"> <a href="https://protriathletes.org/pto-world-ranking-system/">Click here for more info on the calculations.</a></p>
  </div>
  </div>
  ...
  <div class="col-span-1 mx-auto max-w-xl">
        ...
        <h2 class="text-2xl font-semibold underline decoration-dotted transition duration-150 ease-in-out"
        data-te-toggle="tooltip"
        title="Please enter the PTO points for the 5 athletes ranked the highest on the PTO rankings who will start this race.">Pre Race Info </h2>
  ...
  <div class="col-span-1 mx-auto max-w-xl">
    ...
    <h2 class="text-2xl font-semibold underline decoration-dotted transition duration-150 ease-in-out"
        data-te-toggle="tooltip"
        title="Please enter how many pro athletes finished the race as well as the top 5 finishers times. You can also insert your time and position to see how you stack up.">Results Info </h2>
       
              
        <div class="relative py-2">
          <input class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" type="number" placeholder=" " id="numberfinishers"/>
          <label for="numberfinishers" class="absolute text-sm duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">Number of finishers</label>
        </div>
        
        <div class="relative py-2">
          <input class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" type="time" step="1" id="finisher1"/>
          <label for="finisher1" class="absolute text-sm duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">Winners Time</label>
        </div>

        <div class="relative py-2">
          <input class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" type="time" step="1" id="finisher2"/>
          <label for="finisher2" class="absolute text-sm duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">Second Place</label>
        </div>

        <div class="relative py-2">
          <input class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" type="time" step="1" id="finisher3"/>
          <label for="finisher3" class="absolute text-sm duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">Third Place</label>
        </div>

        <div class="relative py-2">
          <input class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" type="time" step="1" id="finisher4"/>
          <label for="finisher4" class="absolute text-sm duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">Fourth Place</label>
        </div>

        <div class="relative py-2">
          <input class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" type="time" step="1" id="finisher5"/>
          <label for="finisher5" class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">Fifth Place</label>
        </div>

        <div class="relative py-2">
          <input class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" type="time" step="1" id="finisheryou"/>
          <label for="finisheryou" class="absolute text-sm duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">Your Time</label>
        </div>

         <div class="relative py-2">
          <input class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:border-gray-600 dark:focus:border-ao-orange focus:outline-none focus:ring-0 focus:border-ao-orange peer" type="number" placeholder=" " id="finisherplace"/>
          <label for="finisherplace" class="absolute text-sm duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0]  px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">Your Place</label>
        </div>
  ...
  <div class="flex grid grid-cols-3 gap-4 p-4">
    ...
    <div class="col-span-3 mx-auto text-center justify-center" id="result4">
        <div class="tooltip"><h2 class="text-2xl font-semibold">Total Points</h2><span class="tooltiptext">Combination of Position, Strength of Field and Time.</span></div>
  ...
  <div class="flex grid grid-cols-3 gap-4 p-4">
    <div class="col-span-1 mx-auto max-w-lg text-center p-4" id="result1">
      <div class="tooltip"><h2 class="text-2xl font-semibold underline decoration-dotted">Position Points</h2><span class="tooltiptext">Points allocated for placing in a particular tiered race.</span></div>
            ...
            <p id="positionexplain"></p>
      </div>   
  
      <div class="col-span-1 mx-auto max-w-lg text-center p-4" id="result2">    
      <div class="tooltip"><h2 class="text-2xl font-semibold underline decoration-dotted">Strength of Field Points</h2><span class="tooltiptext">How strong the field is based on top 5 ranked athletes starting the race.</span></div>
          
            <p id="sofpoints"></p>
            <p id="sofexplain"></p>
    </div>
  
    <div class="col-span-1 mx-auto max-w-lg text-center p-4" id="result3">   
      <div class="tooltip"><h2 class="text-2xl font-semibold underline decoration-dotted">Time Points</h2><span class="tooltiptext">Points allocated based on the calculated "average time", SOF and race tier. Number of finishers also impacts this.</span></div>
