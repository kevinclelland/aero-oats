<body>
    ...
    <div class="flex grid grid-cols-3 gap-4 p-4">
        ...
        <div class="col-span-3 mx-auto max-w-lg">
          <p class="text-center text-ao-pink dark:text-ao-orange text-3xl font-semibold p-4">Time Distance Pace</p>
...
-->
            ...
            <div class="space-y-2">
                <label class="flex items-center space-x-2">
                    ...
                    <input class="radio" type="radio" checked name="radio-direct" value="time" id="timeselect" on:change={selectionFunction} />
                    <p>TIME given distance and pace</p>
                </label>
                <label class="flex items-center space-x-2">
                    <!-- svelte-ignore missing-declaration -->
                    <input class="radio" type="radio" name="radio-direct" value="distance" id="distanceselect" on:change={selectionFunction} />
                    <p>DISTANCE given time and pace</p>
                </label>
                <label class="flex items-center space-x-2">
                    <!-- svelte-ignore missing-declaration -->
                    <input class="radio" type="radio" name="radio-direct" value="pace" id="paceselect" on:change={selectionFunction} />
        ...
        <div class="col-span-3 mx-auto max-w-lg">
            ...
            <h2 class="text-2xl font-semibold text-center">Inputs</h2><br>
            

            <label class="label p-2 flex items-center justify-end" id="timeInputDiv">
                <span class="px-2">Input Time</span>
                <input class="input text-lg p-2 max-w-xs" type="time" step="1" placeholder="00:00:00 " id="time"/>
              </label>
            ...
            <label class="label p-2 flex items-center justify-end" id="distanceInputDiv">
              ...
              <label class="label p-2 flex items-center justify-end" id="paceInputDiv">
                ...
                <input class="input text-lg p-2 max-w-xs" type="time" step="1" placeholder="00:00:00" id="pace"/>
              </label>
  ...
  <div class="col-span-3 mx-auto max-w-lg text-center">
      ...
      <div id="result1">    
        ...
        <div class="col-span-3 mx-auto max-w-lg text-center">
        <div id="result2">    
          <div class="tooltip"><h2 class="text-2xl font-semibold">Result Distance</h2><span class="tooltiptext">How far you can go given a time and a pace.</span></div>
        ...
        <div class="col-span-3 mx-auto max-w-lg text-center">
        <div id="result3">    
          <div class="tooltip"><h2 class="text-2xl font-semibold">Result Pace</h2><span class="tooltiptext">How fast a distance can be covered given a time.</span></div>
