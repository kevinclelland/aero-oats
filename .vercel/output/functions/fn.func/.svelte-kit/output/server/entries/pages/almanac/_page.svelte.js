...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	return `<header class="w-full text-slate-950"><nav class="flex flex-col md:flex-row gap-3 items-center justify-around bg-stone-300 py-5 px-4"><div class="md:w-2/12 text-center md:text-left"><p class="font-serif text-xl font-bold">By Aero Oats.</p>
      ...
      <div class="flex md:w-2/12 w-full flex-col items-center justify-center border border-black text-xl font-bold"><h1>WILL BE UPDATED</h1>
        <h1>REGULARLY!</h1></div></nav></header>
  
    <section class="mx-auto flex items-center justify-between border-t border-b border-black bg-stone-300 py-3 px-5 font-thin text-slate-950"><span>Volume I</span>
      <span>June 2023</span>
      <span>Price: free</span></section>
    <section class="bg-stone-300 py-5 text-slate-950"><h1 class="text-center font-serif text-7xl font-black">ROTH IS COMING</h1>
      <h1 class="mt-5 text-center font-serif text-4xl font-black italic">The biggest longdistance triathlon in the world</h1></section>
  
    <div class="bg-stone-300"><section class="mx-auto grid w-full max-w-7xl md:grid-cols-4 gap-x-3 bg-stone-300 p-4 text-slate-950"><article class="col-span-2 p-3"><img class="mb-5 h-auto border border-4 border border-black/50 grayscale" src="https://protriathletes.org/wp-content/uploads/2023/05/Anne-Haug-Wins-PTO-European-Open-in-Ibiza-@-6-May-2023-.jpg" alt="old">
        ...
        <p class="font-sans text-sm">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ducimus nulla voluptate itaque. Doloremque eveniet est, ratione illo atque, ut hic nemo earum rem, in tempore! Placeat commodi exercitationem sit sed.</p>
        <p class="font-sans text-sm">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ducimus nulla voluptate itaque. Doloremque eveniet est, ratione illo atque, ut hic nemo earum rem, in tempore! Placeat commodi exercitationem sit sed.</p>
        <p class="font-sans text-sm">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ducimus nulla voluptate itaque. Doloremque eveniet est, ratione illo atque, ut hic nemo earum rem, in tempore! Placeat commodi exercitationem sit sed.</p></article>
      <article class="col-span-1"><h1 class="text-center font-serif text-3xl font-bold italic">Lorem ipsum vicinum?</h1>
      ...
      <article class="col-span-1"><div class="3 flex flex-col items-center justify-center border border-4 border-black py-4 px-2"><h1 class="text-3xl">LOREM SERBIA NEWS</h1></div>
        <div class="mt-6"><h1 class="text-center font-serif text-xl font-bold">By Nikola Mrsic.</h1>
          <p class="first-letter:font-serif first-letter:text-3xl">Lorem ipsum dolor sit amet consectetur adipisicing elit. Officia, sint? Eos aliquam, maiores minima amet doloremque veritatis consectetur iusto autem facilis laudantium nisi, dolor enim impedit inventore quis, quisquam veniam!</p>
          <br>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Officia, sint? Eos aliquam, maiores minima amet doloremque veritatis consectetur iusto autem facilis laudantium nisi, dolor enim impedit inventore quis, quisquam veniam!</p>
          <br>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Officia, sint? Eos aliquam, maiores minima amet doloremque veritatis consectetur iusto autem facilis laudantium nisi, dolor enim impedit inventore quis, quisquam veniam!</p></div></article></section>
  <hr class="m-auto my-4 w-full border border-black/40">
    <section class="mx-auto grid w-full max-w-7xl md:grid-cols-4 grid-cols-1 gap-x-3 bg-stone-300 p-4 text-slate-950"><article class="col-span-1"><h1 class="text-center font-serif text-3xl font-bold italic">Lorem ipsum vicinum?</h1>
        <hr class="m-auto my-4 w-[150px] border-2 border-black">
        <h1 class="mt-3 text-center text-xl font-bold italic">Lorem ipsum dolor sit amet consectetur adipisicing elit?</h1>
        <hr class="m-auto my-4 w-[150px] border-2 border-black">
        <div><h1 class="text-center font-serif text-xl font-bold">By Nikola Mrsic.</h1>
      ...
      <article class="col-span-3 p-3"><hr class="m-auto my-4 w-[150px] border-2 border-black">
        <h1 class="mb-3 text-center font-serif text-6xl">NOVI SAD SERBIA</h1>
  <hr class="m-auto my-4 w-[150px] border-2 border-black">
        <img class="mb-5 h-auto w-full border border-4 border border-black/50 grayscale" src="https://protriathletes.org/wp-content/uploads/2022/07/IKT_7549.jpg" alt="old">
