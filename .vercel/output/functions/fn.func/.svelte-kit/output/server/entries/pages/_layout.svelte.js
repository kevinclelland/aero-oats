import { c as create_ssr_component, e as escape, a as add_attribute, b as compute_slots, d as subscribe, f as createEventDispatcher, v as validate_component } from "../../chunks/index3.js";
import { w as writable } from "../../chunks/index2.js";
import { m as modeCurrent, s as setInitialClassState, A as Avatar } from "../../chunks/ProgressBar.svelte_svelte_type_style_lang.js";
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data);
  return `${validate_component(Drawer, "Drawer").$$render($$result, { class: "max-w-md" }, {}, {
    default: () => {
...
${validate_component(AppShell, "AppShell").$$render(
	...
	${validate_component(Transition, "PageTransition").$$render($$result, { url: data.url }, {}, {
          default: () => {
