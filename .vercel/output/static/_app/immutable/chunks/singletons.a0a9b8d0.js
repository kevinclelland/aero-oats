import { w as u } from './index.8bec3548.js';
var p;
const k = ((p = globalThis.__sveltekit_1798x5l) == null ? void 0 : p.base) ?? '';
var h;
const m = ((h = globalThis.__sveltekit_1798x5l) == null ? void 0 : h.assets) ?? k,
	w = '1687877418881',
...
function U(e, t) {
	...
	const o = e instanceof SVGAElement ? e.target.baseVal : e.target,
		l = !n || !!o || A(n, t) || (e.getAttribute('rel') || '').split(/\s+/).includes('external'),
		r = (n == null ? void 0 : n.origin) === location.origin && e.hasAttribute('download');
	return { url: n, external: l, target: o, download: r };
}
function L(e) {
	let t = null,
		n = null,
...
function _(e) {
	...
	return { notify: o, set: l, subscribe: r };
}
function E() {
	...
	async function o() {
		clearTimeout(n);
		try {
			const l = await fetch(`${m}/_app/version.json`, {
				headers: { pragma: 'no-cache', 'cache-control': 'no-cache' }
			});
			if (!l.ok) return !1;
			const a = (await l.json()).version !== w;
...
const V = { url: _({}), page: _({}), navigating: u(null), updated: E() };
export {
	y as I,
	f as P,
	x as S,
